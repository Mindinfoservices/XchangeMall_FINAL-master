...
//                    try {
//                        response = NetworkClass.POST(client, "login", NetworkClass.Loginrequest(email, password, "", ""));
//
...
//                            saveData(getApplicationContext(), "user_profile_pic", "");
//                            saveData(getApplicationContext(), "user_name", namefbuser);
//                            saveData(getApplicationContext(), "user_id", user_id);
//                            new NetworkClass().getloginresponse(Login.this, s);
//                            Log.e("response", s);
//                        }
